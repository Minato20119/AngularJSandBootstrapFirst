		...
		[
			...
			function(BookService, $scope) {
				...
				function createUser(book) {
					...
					BookService.createUser(book).then(
						function(response) {
				...
				function updateUser(book, id) {
					...
					BookService.updateUser(book, id).then(
						function(response) {
				...
				function removeUser(id) {
					...
					BookService.removeUser(id).then(
